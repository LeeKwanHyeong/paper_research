...
| Intermittent | TitanTPP V2 | 42 | draft_only | 200 | 27 | initial_budget_met, strict, source_revision, validation_only, held_out_test_locked, best_val_nll_state_hash, dataset_hashes_missing |
| Intermittent | TitanTPP V2 | 52 | draft_only | 200 | 90 | initial_budget_met, strict, source_revision, validation_only, held_out_test_locked, best_val_nll_state_hash, dataset_hashes_missing |
| Intermittent | TitanTPP V2 | 62 | draft_only | 200 | 168 | initial_budget_met, strict, source_revision, validation_only, held_out_test_locked, best_val_nll_state_hash, dataset_hashes_missing |
...
| Taxi | TitanTPP V3b | 42 | draft_only | 50 | 29 | initial_budget_met, source_revision, best_val_nll_checkpoint, run_config_missing, run_config |
...
| Taxi | TitanTPP V2 control | 42 | draft_only | 50 | 43 | initial_budget_met, source_revision, best_val_nll_checkpoint, run_config_missing, run_config |
| Taxi | TitanTPP V2 control | 52 | draft_only | 200 | 148 | initial_budget_met, strict, source_revision, validation_only, held_out_test_locked, best_val_nll_state_hash, dataset_hashes_missing |
| Taxi | TitanTPP V2 control | 62 | draft_only | 200 | 150 | initial_budget_met, strict, source_revision, validation_only, held_out_test_locked, best_val_nll_state_hash, dataset_hashes_missing |
...
| Instacart | TitanTPP V2 | 42 | draft_only | 200 | 20 | initial_budget_met, strict, source_revision, validation_only, held_out_test_locked, best_val_nll_state_hash, dataset_hashes_missing |
| Instacart | TitanTPP V2 | 52 | draft_only | 200 | 112 | initial_budget_met, strict, source_revision, validation_only, held_out_test_locked, best_val_nll_state_hash, dataset_hashes_missing |
| Instacart | TitanTPP V2 | 62 | draft_only | 200 | 24 | initial_budget_met, strict, source_revision, validation_only, held_out_test_locked, best_val_nll_state_hash, dataset_hashes_missing |
