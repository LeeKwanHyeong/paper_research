...
OUTPUT_ROOT="${OUTPUT_ROOT:-${PROJECT_ROOT}/search_artifacts/count_aware_instacart_t0_e300_20260824}"
...
DATA_PATH="${PROJECT_ROOT}/sample_data/insta_market_basket/instacart_marked_target_with_split.parquet"
SPLIT_MANIFEST="${PROJECT_ROOT}/sample_data/insta_market_basket/instacart_marked_target_split_manifest.json"
...
SOURCE_FILES=(
  ...
  "${PROJECT_ROOT}/simple_lab_test/search/scripts/run_count_aware_instacart_t0_e300_20260824.sh"
)
...
COMMAND=(
  ...
  --output-dir "${OUTPUT_ROOT}/insta_market_basket/t0_common_control"
  --source-revision "${SOURCE_REVISION}"
  --execution-role primary_5080_insta_market_basket_t0_common_control_e300
...
export MPLCONFIGDIR="${MPLCONFIGDIR:-/tmp/mplconfig_instacart_t0_e300}"
export XDG_CACHE_HOME="${XDG_CACHE_HOME:-/tmp/xdg_instacart_t0_e300}"
