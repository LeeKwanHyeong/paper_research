...
OUTPUT_ROOT="${OUTPUT_ROOT:-${PROJECT_ROOT}/search_artifacts/intermittent_log_backbone_control_e300_20260811}"
...
CMD=(
  "${PYTHON_BIN}" "${PROJECT_ROOT}/paper/scripts/run_intermittent_log_backbone_control.py"
  --data "${DATA}"
...
export MPLCONFIGDIR="${MPLCONFIGDIR:-/tmp/mplconfig_inter_log_backbone}"
export XDG_CACHE_HOME="${XDG_CACHE_HOME:-/tmp/xdg_inter_log_backbone}"
