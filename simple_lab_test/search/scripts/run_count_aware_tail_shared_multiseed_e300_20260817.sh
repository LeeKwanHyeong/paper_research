...
OUTPUT_ROOT="${OUTPUT_ROOT:-${PROJECT_ROOT}/search_artifacts/count_aware_tail_shared_multiseed_extension_e300_20260817}"
...
EXECUTION_ROLE="${EXECUTION_ROLE:-primary_5080_multiseed_extension}"
...
SOURCE_FILES=(
  ...
  "${PROJECT_ROOT}/paper/scripts/build_count_aware_tail_shared_multiseed_results.py"
  "${PROJECT_ROOT}/paper/scripts/run_count_aware_tpp_backbone_control.py"
  "${PROJECT_ROOT}/simple_lab_test/search/scripts/run_count_aware_tail_shared_multiseed_e300_20260817.sh"
)
...
export MPLCONFIGDIR="${MPLCONFIGDIR:-/tmp/mplconfig_count_tail_multiseed}"
export XDG_CACHE_HOME="${XDG_CACHE_HOME:-/tmp/xdg_count_tail_multiseed}"
