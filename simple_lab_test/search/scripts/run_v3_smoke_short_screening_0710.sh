...
run_long_epoch model_enhancement_v3_insta_smoke_e1_0710 \
...
run_long_epoch model_enhancement_v2_inter_short_e50_0710 \
...
run_long_epoch model_enhancement_v3_inter_short_e50_0710 \
  --datasets intermittent \
  --models titantpp \
  --titan-candidates small_lmm \
  --epochs 50 \
...
run_long_epoch model_enhancement_v2_taxi_short_e50_0710 \
...
run_long_epoch model_enhancement_v3_taxi_short_e50_0710 \
  --datasets yellow_trip_hourly \
  --models titantpp \
  --titan-candidates mid_lmm \
  --epochs 50 \
